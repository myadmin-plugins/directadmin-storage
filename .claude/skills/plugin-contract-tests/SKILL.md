...
The class under contract here is `Detain\MyAdminDirectAdminStorage\Plugin`.
...
- This package declares `$module = 'backups'`. Changing it detaches the plugin from the events core dispatches to it, so the generated pin asserts it.
